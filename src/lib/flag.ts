// src/lib/flag.ts
// Maps ISO 3166-1 alpha-3 country codes (used in our database) to alpha-2,
// then converts alpha-2 to a flag emoji using regional indicator symbols.
...
const ALPHA3_TO_ALPHA2: Record<string, string> = {
  ...
  VEN: "VE", VNM: "VN", YEM: "YE", ZMB: "ZM", ZWE: "ZW", XKX: "XK", HKG: "HK",
};

export function codeToFlag(alpha3: string): string {
  const alpha2 = ALPHA3_TO_ALPHA2[alpha3.toUpperCase()];
  if (!alpha2) return "";
  // Each letter -> regional indicator symbol (offset 127397 from ASCII).
